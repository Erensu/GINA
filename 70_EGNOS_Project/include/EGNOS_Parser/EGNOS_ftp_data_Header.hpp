...
namespace EGNOS_ftp_data_Parser {
	...
	class EGNOS_ftp_data_Header : public EGNOS_ftp_data_Base
	{
	public:
		...
		bool EGNOS_ftp_data_Header::isPosFormatSet;
		bool EGNOS_ftp_data_Header::isHeaderEnd;
		bool EGNOS_ftp_data_Header::firstLineisRead;
		bool EGNOS_ftp_data_Header::valid;
		...
		static const int EGNOS_ftp_data_Header::numberofLineinHeader;
		static const string EGNOS_ftp_data_Header::startofHeaderGinaTag;
		static const string EGNOS_ftp_data_Header::secondLineOfIMUTrajectoryTag;
		static const string EGNOS_ftp_data_Header::creatorOfFileTag;
		static const string EGNOS_ftp_data_Header::timeofCreationTag;
		static const string EGNOS_ftp_data_Header::positionTypeLLHTag;
		static const string EGNOS_ftp_data_Header::positionTypeUnknownTag;
		static const string EGNOS_ftp_data_Header::positionTypeECEFTag;
		static const string EGNOS_ftp_data_Header::timeSystemDefinitionTag;
		static const string EGNOS_ftp_data_Header::startTimeTag;
		static const string EGNOS_ftp_data_Header::endTimeTag;
		static const string EGNOS_ftp_data_Header::startPositionTag;
		static const string EGNOS_ftp_data_Header::startVelocityTag;
		static const string EGNOS_ftp_data_Header::startAttitudeTag;
		static const string EGNOS_ftp_data_Header::EpochIntervalTag;
		static const string EGNOS_ftp_data_Header::endOfHeaderTag;
